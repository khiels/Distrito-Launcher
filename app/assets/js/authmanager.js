...
// Functions
/**
 * Adds a cracked account.
 * 
 * @param {string} username The cracked account username.
 * @returns {Object} The cracked account object created by this action.
 */

exports.addAccount = async function(username) {
    const ret = ConfigManager.addAccount(username)
    ConfigManager.save()
    return ret
}

/**
 * Removes a cracked account.
 * 
 * @param {string} uername The cracked account username.
 */

exports.removeAccount = async function(username) {
    ConfigManager.removeAuthAccount(username)
    ConfigManager.save()
}
