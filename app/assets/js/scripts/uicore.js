    ...
    ipcRenderer.on('autoUpdateNotification', (event, arg, info) => {
        switch(arg){
            case 'checking-for-update':
                ...
                settingsUpdateButtonStatus('Checando atualizações..', true)
                break
            case 'update-available':
                loggerAutoUpdaterSuccess.log('Novas atualizações disponiveis', info.version)
            ...
            case 'update-downloaded':
                ...
                settingsUpdateButtonStatus('Instalar agora', false, () => {
                    if(!isDev){
            ...
            case 'update-not-available':
                ...
                settingsUpdateButtonStatus('Checar atualizações')
                break
            case 'ready':
